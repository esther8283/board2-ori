...
// @RestController는 어노테이션과 @ResponseBody 어노테이션이 합쳐진 어노테이션
// @RestponseBody 어노테이션은 View에 데이터를 직접 전송하는 어노테이션
@RestController
...
//	POST, PUT을 사용하는 경우에는 메서드에 @RequestBody 어노테이션을 사용해야 함
